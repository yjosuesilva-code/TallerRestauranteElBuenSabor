    ...
    public static void mostrarPedido() {
        ...
        while (i < Datos.nombres.length) {
            if (Datos.cantidades[i] > 0) {
                ...
                System.out.printf("%-20s nombreRestaurante%-6d $%,.0f%n", Datos.nombres[i], Datos.cantidades[i], (Datos.precios[i] * Datos.cantidades[i]));
                // suma al subtotal
    ...
    public static void imprimirFacturaCompleta() {
        ...
        while (j < Datos.nombres.length) {
            if (Datos.cantidades[j] > 0) {
                System.out.printf("%-20s nombreRestaurante%-6d $%,.0f%n", Datos.nombres[j], Datos.cantidades[j], (Datos.precios[j] * Datos.cantidades[j]));
            }
            j++;
        }// fin while
        System.out.println("----------------------------------------");
